...
//     let url = `https://www.fema.gov/api/open/v1/DisasterDeclarationsSummaries?$filter=${stateFilter} incidentBeginDate ge '${incidentBeginDate}' and incidentEndDate lt '${incidentEndDate}'`;
...
//         if (result.length > 999) notify("Results limited to 1000!", {});
//         let sizeLimit = 1000;
